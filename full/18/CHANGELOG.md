# 18.0.0
* PostgreSQL 18 full build, compiled from the `18-constructive` branch of constructive-io/libpg_query
* Full API: parse, parsePlPgSQL, scan, fingerprint, normalize + sync variants
* Uses @pgsql/types ^18.0.0
* Published as @libpg-query/parser under the `pg18` dist-tag
